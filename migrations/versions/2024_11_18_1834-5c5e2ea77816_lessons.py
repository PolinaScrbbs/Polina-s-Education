...
def upgrade() -> None:
    ...
    sa.Column('type', sa.Enum('THEORY', 'TEST', 'PRACTICE', name='lessontype'), nullable=False),
    ...
    sa.Column('status', sa.Enum('SENT', 'VIEWED', 'SENT_FOR_REVISION', 'APPRECIATED', name='lessonresultstatus'), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('last_updated_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['lesson_id'], ['lessons.id'], ),
    sa.ForeignKeyConstraint(['student_id'], ['lessons.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    op.create_table('lesson_result_contents',
    sa.Column('lesson_result_id', sa.Integer(), nullable=True),
    sa.Column('content_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['content_id'], ['contents.id'], ),
    sa.ForeignKeyConstraint(['lesson_result_id'], ['lesson_results.id'], ),
    sa.UniqueConstraint('lesson_result_id', 'content_id', name='uq_lesson_result_content')
    )
    op.create_table('lesson_result_evaluations',
    sa.Column('id', sa.Integer(), nullable=False),
